...
public:
    ...
    virtual C_ViewSetup*        GetPlayerViewSetup(void) const = 0;
    virtual C_ViewSetup*        GetViewSetup(void) const = 0;
    ...
    virtual void                SetScreenOverlayMaterial(C_Material *pMaterial) = 0;
    virtual C_Material*         GetScreenOverlayMaterial() = 0;
