...
{
public: 
    GlowObjectDefinition_t( ) { memset( this, NULL, sizeof( GlowObjectDefinition_t ) ); }

    int m_nNextFreeSlot;
    class C_ClientEntity* m_pEntity;    //0x0000
    union
    {
...
{
public:
    int RegisterGlowObject(C_ClientEntity* pEntity, const Vector& vGlowColor, float flGlowAlpha, bool bRenderWhenOccluded, bool bRenderWhenUnoccluded, int nSplitScreenSlot)
    {
        int nIndex;
    ...
    void SetEntity(int nGlowObjectHandle, C_ClientEntity* pEntity)
    {
    ...
    bool HasGlowEffect(C_ClientEntity* pEntity) const
    {
