...
public:
    ...
    virtual bool RenderBrushModelSurface(C_ClientEntity* pBaseEntity, C_BrushSurface* pBrushSurface) = 0;
};
...
public:
    virtual void      DrawBrushModel(C_ClientEntity* pBaseEntity, model_t* pModel, const Vector& vecOrigin, const QAngle& angView, bool bSort) = 0;
    ...
    virtual void      DrawBrushModelShadowDepth(C_ClientEntity* pEntity, model_t* pModel, const Vector& vecOrigin, const QAngle& angView, int nDepthMode) = 0;
    ...
    virtual void      DrawBrushModelEx(C_ClientEntity* pEntity, model_t* pModel, const Vector& vecOrigin, const QAngle& angView, int nMode) = 0;
