...
struct BeamInfo_t {
	...
	// Entities
	C_ClientEntity* m_pStartEnt;
	int			m_nStartAttachment;
	C_ClientEntity* m_pEndEnt;
...
class C_ViewRenderBeams
{
public:
	// Construction
public:
	C_ViewRenderBeams( void );
	virtual				~C_ViewRenderBeams( void );
...
public:
	...
	virtual	void		KillDeadBeams( C_ClientEntity *pDeadEntity );
